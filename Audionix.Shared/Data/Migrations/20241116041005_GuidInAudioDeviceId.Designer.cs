...
namespace Audionix.Shared.Data.Migrations
{
    ...
    [Migration("20241116041005_GuidInAudioDeviceId")]
    partial class GuidInAudioDeviceId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Audionix.Shared.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Audionix.Shared.Models.AudioDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Audionix.Shared.Models.AudioMetadata", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Audionix.Shared.Models.Folder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Audionix.Shared.Models.MusicSchedule.Category", b =>
                {
            ...
            modelBuilder.Entity("Audionix.Shared.Models.MusicSchedule.Grid", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Audionix.Shared.Models.MusicSchedule.MusicGridItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Audionix.Shared.Models.MusicSchedule.MusicPattern", b =>
                {
            ...
            modelBuilder.Entity("Audionix.Shared.Models.MusicSchedule.PatternCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Audionix.Shared.Models.ProgramLogItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Audionix.Shared.Models.Station", b =>
                {
                    b.Property<Guid>("StationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Audionix.Shared.Models.AudioMetadata", b =>
                {
                    b.HasOne("Audionix.Shared.Models.Station", "Station")
                        .WithMany("AudioFiles")
            ...
            modelBuilder.Entity("Audionix.Shared.Models.MusicSchedule.Category", b =>
                {
                    b.HasOne("Audionix.Shared.Models.MusicSchedule.MusicPattern", "Template")
                        .WithMany()
            ...
            modelBuilder.Entity("Audionix.Shared.Models.MusicSchedule.PatternCategory", b =>
                {
                    b.HasOne("Audionix.Shared.Models.MusicSchedule.Category", "Category")
                        .WithMany("PatternCategories")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Audionix.Shared.Models.MusicSchedule.MusicPattern", "MusicPattern")
                        .WithMany("PatternCategories")
            ...
            modelBuilder.Entity("Audionix.Shared.Models.Station", b =>
                {
                    b.HasOne("Audionix.Shared.Models.AudioDevice", "AudioDevice")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Audionix.Shared.Data.ApplicationUser", null)
                        .WithMany()
